create database CTE;
use CTE;
-- Find Employees with Salary Greater Than Average Table: employees : emp_id , emp_name , department , salary Create a CTE named avg_salary that calculates the average salary of all employees. Then display employees whose salary is greater than the average salary.
